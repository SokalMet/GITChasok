namespace Chasok4.Migrations
{
    ...
    public partial class GoodModelNow : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MessadeToId = c.Int(nullable: false),
                        ReceiverId = c.String(maxLength: 128),
                        MessageTo_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Messages", t => t.MessageTo_Id)
                .ForeignKey("dbo.AspNetUsers", t => t.ReceiverId)
                .Index(t => t.ReceiverId)
                .Index(t => t.MessageTo_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserMessages", "MessageTo_Id", "dbo.Messages");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Messages", "CreatorId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.UserMessages", new[] { "MessageTo_Id" });
